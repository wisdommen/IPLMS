...
class Client(object):
    ...
    def __init__(self):
        ...
        column1 = [
            [sg.Text("Client Telephone Number:", font=("arial", 10), background_color="white", text_color="black", justification="right")],
            [sg.Text("Client Name: ",font=("arial", 10), background_color="white", text_color="black", justification="right")],
        ...
        column_all = [
            ...
            [sg.Column(column1, background_color="white", key="_CP_PHONE_COLUMN_",pad=(10,10), justification="left"), sg.Column(column2, background_color="white", key="_CP_NAME_COLUMN_",pad=(10,10), justification="right")],
