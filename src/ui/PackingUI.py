...
class Packing_UI(UI):
    ...
    def __init__(self):
        ...
        title = [
            [sg.Text("Loading Department Use ONLY", font=("Helvetica", 25), size=(30, 1), background_color="white",
        ...
        column1 = [
            [sg.Text("Client information:", size=(20, 1), background_color="white", text_color="black",
             ...
             sg.InputCombo(values=[], size=(19, 1), key="_PL_CLIENT_CB_"),
        ...
        column_all = [
            [sg.Column(title, pad=(10, 10), background_color="white", key="_PL_TITL_COLUMN_", justification="center")],
            [sg.Column(column1, pad=(20, 10), background_color="white", key="_PL_COLUMN_1_"),
             sg.Column(column2, pad=(20, 10), background_color="white", key="_PL_COLUMN_2_")],
    ...
    def get_need_validate_fields(self) -> map:
        ...
        return {
            ...
            "_PL_DATE_IP_": "[0-9]{4}-[0-1]{1}[0-9]{1}-[0-3]{1}[0-9]{1} [0-2]{1}[0-9]{1}:[0-6]{1}[0-9]{1}:[0-6]{1}[0-9]{1}",
            "_PL_PACK_SP_": "[^0-9]",
            "_PL_NET_SP_": "[^0-9.]",
            "_PL_GROSS_SP_": "[^0-9.]",
            "_PL_CBM_SP_": "[^0-9.]"
